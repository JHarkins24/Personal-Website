    ...
    <section className="interests--section" id="interests">
      <div className="portfolio--container-box">
        <div className="portfolio--container">
          <p className="sub--title">Interests</p>
          <h2 className="sections--heading">Interests & Hobbies</h2>
        </div>
      </div>
      <div className="portfolio--section--container">
        {data?.interests?.map((item, index) => (
          <div key={index} className="interests--section--card">
            <div className="interests--section--card--review">
            ...
            <div className="interests--section--card--author--detail">
              <img src={item.src} alt="Avatar" />
              <div>
                <p className="text-md interests--author--name">
                  {item.author_name}
                </p>
                <p className="text-md interests--author--designation">
