          ...
          <span className="close-btn" onClick={closeCarousel}>&times;</span>
            ...
            <div className="hero--section--content--box about--section--box">
                <div className="hero--section--content">
                    ...
                    <p className="hero--section--description">
                        When I'm not developing side projects, I enjoy spending my weekend's working on and tracking my car while also restoring classic games and competing in super smash bros. melee tournaments.
                    </p>
                </div>
            </div>
        </section>
